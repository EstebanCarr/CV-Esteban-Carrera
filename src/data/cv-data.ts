export const cvData = {
  ...
  skills: {
    technical: [
      ...
      "Web 3.0", "Multimedia", "E-commerce", "Git", "Responsive Design"
    ],
    soft: [
      "Innovación", "Mejora continua", "Resolución de problemas",
      "Adaptabilidad", "Pensamiento crítico", "Autodidacta"
    ]
  },
